...
function Search({ houses }) {
    ...
    return (
        <>
            ...
            <Global>
                <FilterContainer>
                    <FilledButton margin="1rem" width="10rem" height="3rem" fontSize="1rem"> Région </FilledButton>
                    <FilledButton margin="1rem" width="10rem" height="3rem" fontSize="1rem"> Voyageurs </FilledButton>
                    <FilledButton margin="1rem" width="10rem" height="3rem" fontSize="1rem"> Arrivée </FilledButton>
                    <FilledButton margin="1rem" width="10rem" height="3rem" fontSize="1rem"> Départ </FilledButton>
