  ...
  return (
    <>
      <Banner
        ...
        marginTop="none"
        marginBottom="0.5em"
        image="url('./ressources/banner-nos-services.jpg')"
      >
        Nos Services
      </Banner>
      <Global>
        <ServicesContainer>
          {servicesData.map((service) => (
            <ServicesPanel key={service.id} service={service} />
          ))}
        </ServicesContainer>
      </Global>
      <Banner
        ...
        marginTop="2em"
        marginBottom="0.5em"
        image="url('./ressources/banner-activites-exterieures.jpg')"
      >
      ...
      <Global>
        <ActivitiesContainer>
          <Card>
            <Image
              src="./ressources/visite-chateau.jpeg"
              alt="chateau-cathare"
            />
          ...
          <Card>
            <Image
              src="./ressources/ballade-cheval.jpeg"
              alt="ballade a cheval"
            />
          ...
          <Card>
            <Image
              src="./ressources/gastronomie-locale.JPG"
              alt="gastronomie"
            />
